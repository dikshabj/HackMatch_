...
const Login = () => {
  ...
  const handleOAuthLogin = (provider) => {
    // Backend port 8083 use ho raha hai
      ...
      >
        <div className="glass-card p-8 md:p-10 border-maroon/20 bg-black/40 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black mb-2 uppercase tracking-tight">Access <span className="text-maroon">Vault</span></h1>
            <p className="text-gray-500 text-xs font-space tracking-widest uppercase">Enter your credentials to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end mt-1">
                <Link to="/forgot-password" size={18} className="text-[10px] text-maroon hover:text-maroon-light transition-colors uppercase tracking-widest font-bold">
                  Forgot Identity?
                </Link>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-xs text-gray-500 font-inter">
            New to the alliance? <Link to="/signup" className="text-maroon hover:underline font-bold">Register Identity</Link>
          </p>
        </div>
      </motion.div>
    </div>
